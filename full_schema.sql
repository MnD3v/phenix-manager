...
ALTER TABLE public.biens ADD COLUMN IF NOT EXISTS commission_pourcentage numeric DEFAULT 10 NOT NULL;
...
ON public.rapports_historique 
FOR DELETE 
USING (true);-- Fix notifications RLS to allow authenticated users to view all notifications
